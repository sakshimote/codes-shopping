...
export class RegistrationService{
  ...
  public postRegistration(user:User):Observable<User>{
    return this.http.post<User>(this.postRegistrationApi,user,{headers: { authorization: this.loginService.createBasicAuthToken(this.loginService.username, this.loginService.password) } })
