...
public getReviewsBypID(productId:string):Observable<Review[]>{
 ...
 public getProductsByProductId(productId:String):Observable<Product>{
  return this.http.get<Product>(this.getProductByProductId+productId,{headers: { authorization: this.loginService.createBasicAuthToken(this.loginService.username, this.loginService.password) } });

}
public  getProductsByProductName(productName:String):Observable<Product>{
  return this.http.get<Product>(this.getProductByProductName+productName,{headers: { authorization: this.loginService.createBasicAuthToken(this.loginService.username, this.loginService.password) } });
