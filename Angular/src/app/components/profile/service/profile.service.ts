...
export class ProfileServiceService {
  ...
  getUserDetails(userId: string) :Observable<User>{
    return this.http.get<User>(this.getUserDetailsApi+userId,{headers: { authorization: this.loginService.createBasicAuthToken(this.loginService.username, this.loginService.password) } });
  }
